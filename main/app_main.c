...
void app_main()
{
    ...
    esp_rmaker_device_add_param(switch2_device, power_param);
    esp_rmaker_device_add_param(switch3_device, power_param);
    esp_rmaker_device_add_param(switch4_device, power_param);
    ...
    esp_rmaker_device_assign_primary_param(switch2_device, power_param);
    esp_rmaker_device_assign_primary_param(switch3_device, power_param);
    esp_rmaker_device_assign_primary_param(switch4_device, power_param);
